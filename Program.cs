internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        (int, int) start = (1, 0);
        if (ScanLeftLinearForSameValues(values, start))
        {
    ...
    private static bool ScanRightLinearForSumOfTen(int[,] values, (int row, int column) start)
    {
    ...
    private static bool ScanRightLinearForSameValues(int[,] values, (int row, int column) start)
    {
        (int row, int column) inspect = (start.row, start.column + 1);

        int positionValue = values[start.row, start.column];
    ...
    private static bool ScanLeftLinearForSumOfTen(int[,] values, (int row, int column) start)
    {
        (int row, int column) inspect = (start.row, start.column - 1);
    ...
    private static bool ScanLeftLinearForSameValues(int[,] values, (int row, int column) start)
    {
        (int row, int column) inspect = (start.row, start.column - 1);
